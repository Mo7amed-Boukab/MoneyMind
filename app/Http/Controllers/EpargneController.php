...
class epargneController extends Controller
{
    public function viewEpargnePage()
    {
        ...
        return view("dashboard/user/epargne", compact("epargne","userSalaire","epargne_total","epargne_mensuel","objectif_mensuel","objectif_annuel","epargne_objectif_annuel","epargne_annuel"));
    }
