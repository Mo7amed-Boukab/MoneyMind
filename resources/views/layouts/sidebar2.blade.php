   <!-- Sidebar -->
   <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 text-white transition-transform duration-200 ease-in-out transform bg-sidebar-blue lg:translate-x-0 lg:block">
    <div class="p-6">
    ...
    <nav>
      <a href="{{route('admin.index')}}" class="flex items-center px-6 py-3 m-2 text-white transition rounded bg-blue-500/80">
        <i class="mr-3 fas fa-chart-pie"></i>
        <span>Tableau de bord</span>
      </a>
      <a href="{{route('admin.users')}}" class="flex items-center px-6 py-3 m-2 text-white transition rounded hover:bg-blue-950 hover:bg-opacity-30">
        <i class="mr-3 fas fa-users"></i>
        <span>Utilisateurs</span>
      </a>
      <a href="{{route('admin.categorie')}}" class="flex items-center px-6 py-3 m-2 text-white transition rounded hover:bg-blue-950 hover:bg-opacity-30">
