...
<aside id="sidebar1" class="fixed inset-y-0 left-0 z-40 w-64 transition-transform duration-300 transform -translate-x-full bg-sidebar-blue lg:translate-x-0">
 ...
 <nav>
   ...
   <a href="{{route('user.depense')}}" class="flex items-center px-6 py-3 m-2 text-white transition rounded hover:bg-blue-950 hover:bg-opacity-30">
     <i class="mr-3 fas fa-wallet"></i>
     <span>Dépenses</span>
   </a>
   <a href="{{route('user.revenu')}}" class="flex items-center px-6 py-3 m-2 text-white transition rounded hover:bg-blue-950 hover:bg-opacity-30">
     <i class="mr-3 fas fa-money-bill-wave"></i>
     <span>Revenus</span>
   </a>
   <a href="{{route('user.epargne')}}" class="flex items-center px-6 py-3 m-2 text-white transition rounded hover:bg-blue-950 hover:bg-opacity-30">
 ...
 <nav>
   <a href="{{route('user.profile')}}" class="flex items-center px-6 py-3 m-2 text-white transition rounded hover:bg-blue-950 hover:bg-opacity-30">
