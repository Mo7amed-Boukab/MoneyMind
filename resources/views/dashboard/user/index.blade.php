         ...
         <div class="flex items-center space-x-4">
            ...
            <div class="relative flex items-center justify-center cursor-pointer group">
             ...
             <div id="notificationList" class="fixed inset-0 z-50 hidden">
               ...
               <div class="absolute right-4 top-20 w-80 bg-white rounded-md shadow-lg max-h-[80vh] flex flex-col">
                       ...
                       <div class="block px-4 py-3 border-b border-gray-100 hover:bg-gray-50">
                         <div class="flex items-center">
                           ...
                           <form action="{{ route('notifications.lu', $notification->id) }}" method="POST">
                             @csrf
                             <button type="submit" class="ml-2 text-gray-400 hover:text-gray-600">
