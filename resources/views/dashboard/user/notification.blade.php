      ...
      {{-- ------------------------------------- Navigation ----------------------------------- --}}
        <div class="mb-6 border-b border-gray-200">
          <ul class="flex flex-wrap -mb-px text-sm font-medium text-center">
            <li class="mr-2">
              <a href="{{ route('user.notification', ['tab' => 'all']) }}" class="inline-block p-4 {{ request('tab', 'all') == 'all' ? 'text-green-800 border-b-2 border-green-800' : 'text-gray-500 border-transparent' }} rounded-t-lg">
                <i class="mr-2 fas fa-bell"></i>Toutes ({{ count($allNotifications) }})
              </a>
            </li>
            <li class="mr-2">
              <a href="{{ route('user.notification', ['tab' => 'important']) }}" class="inline-block p-4 {{ request('tab') == 'important' ? 'text-green-800 border-b-2 border-green-800' : 'text-gray-500 border-transparent' }} rounded-t-lg hover:text-gray-600 hover:border-gray-300">
