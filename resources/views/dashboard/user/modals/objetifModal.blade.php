<div id="editObjectifModal" class="fixed inset-0 z-50 items-center justify-center hidden overflow-auto bg-black bg-opacity-50">
 <div class="w-full max-w-md p-6 mx-4 bg-white rounded shadow-xl">
     <div class="flex items-center justify-between mb-4">
         <h3 class="text-xl font-bold text-gray-800">Modifier l'objectif d'épargne</h3>
     ...
     <form id="editSavingsGoalForm" action="{{route('epargne.objectif')}}" method="POST">
      @csrf
         <div class="mb-4">
             <label class="block mb-2 text-sm font-medium text-gray-700" for="newSavingsGoalAmount">
                 Nouvel objectif d'épargne (DH)
             </label>
             <input class="w-full px-3 py-2 leading-tight text-gray-700 border rounded appearance-none" id="newSavingsGoalAmount" name="objectif_mensuel" value="{{$epargne->objectif_mensuel}}" type="number" required>
         </div>
