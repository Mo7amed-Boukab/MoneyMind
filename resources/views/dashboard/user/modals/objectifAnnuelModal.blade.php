    ...
    <div class="relative w-full max-w-md p-6 mx-auto bg-white rounded shadow-lg">
        ...
        <form action="{{ route('epargne.objectif-annuel') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="objectif_annuel" name="objectif_annuel" value="{{ $epargne->objectif_annuel }}" class="w-full px-3 py-2 leading-tight text-gray-700 border rounded appearance-none" required>
            </div>
            
            <div class="mb-6">
                <label for="epargne_objectif" class="block mb-2 text-sm font-medium text-gray-700">Montant à épargner chaque mois (DH)</label>
                <input type="number" id="epargne_objectif" name="epargne_objectif" value="{{ $epargne->epargne_objectif }}" class="w-full px-3 py-2 leading-tight text-gray-700 border rounded appearance-none" required>
